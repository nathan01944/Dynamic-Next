import { american_and_wager_to_win, american_to_pct_odds, pct_to_american_odds } from "../../../../common/oddsMath"
...
export default function CreateOffer(game,vig,wager,market) {
    ...
    offerhome.win = american_and_wager_to_win(pct_to_american_odds(offerhome.odds),wager)
    ...
    offeraway.win = american_and_wager_to_win(pct_to_american_odds(offeraway.odds),wager)
